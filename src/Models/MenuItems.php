...
namespace Emresari\Menu\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('Emresari\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('Emresari\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}

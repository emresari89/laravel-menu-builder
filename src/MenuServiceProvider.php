...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../assets' => public_path('vendor/emresari89-menu'),
        ], 'public');
    ...
    {
        $this->app->bind('emresari89-menu', function () {
            return new WMenu();
        });

        $this->app->make('Emresari\Menu\Controllers\MenuController');

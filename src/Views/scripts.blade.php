...
<script type="text/javascript" src="{{asset('vendor/emresari89-menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/emresari89-menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/emresari89-menu/menu.js')}}"></script>